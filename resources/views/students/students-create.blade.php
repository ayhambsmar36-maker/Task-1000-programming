<x-dashboard.app class="container"  >
    <form action="{{ route('students.store') }}" method="POST" style="width: 800px ; border:1px solid primary ;background:#f8f9fa; padding: 20px 30px; border-radius: 10px;"> 
        @csrf
        ...
        <div class="form-group">
            ...
            <x-text-area id="birth-date" name="birth_date" type="date" value="{{ old('birth_date') }}" class="mt-1 block w-full" required />
