<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-between content-between mt-4">
            ...
            <x-secondary-button class="ms-1" style="padding: 10px">
              ...
              <x-primary-button class="ms-3" style="padding: 12px">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
